...
void LReLU::configurePlugin(Dims const* inputDims, int32_t nbInputs, Dims const* outputDims, int32_t nbOutputs,
    ...
    bool const* outputIsBroadcast, PluginFormat floatFormat, int32_t maxBatchSize) noexcept 
{
    ...
    std::cout << DimsToStr(inputDims[0]) << std::endl;
}

IPluginV2Ext* LReLU::clone() const noexcept {
