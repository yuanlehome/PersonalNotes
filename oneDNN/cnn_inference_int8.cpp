/*
https://oneapi-src.github.io/oneDNN/page_cnn_inference_int8_cpp.html#doxid-cnn-inference-int8-cpp

g++ -I ../thirdparty/oneDNN/include/ -I  ../thirdparty/oneDNN/build/include/  cnn_inference_int8.cpp -L /weishengying/oneDNN/build/src/ -ldnnl

这个是官网的demo，有一个疑问，就是 conv 的 bias 数据是 fp32， 但是 conv primitive 要求的输入是 u8， 中间也没做 reorder，但是却不会报错。
*/
