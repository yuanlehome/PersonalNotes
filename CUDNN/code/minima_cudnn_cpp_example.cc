...
size_t GetUsedMemoryInfo() { // return MiB
  size_t avail = 0;
  size_t total = 0;
  size_t used = 0;
...
{    
    ...
    size_t used_mem = GetUsedMemoryInfo();
    std::cout << "pre cudnnCreate, used memory: " << used_mem << " MiB" << std::endl;
    cudnnHandle_t handle_;
    cudnnCreate(&handle_);
    std::cout << "Created cuDNN handle" << std::endl;
    used_mem = GetUsedMemoryInfo();
    std::cout << "after cudnnCreate, used memory: " << used_mem << " MiB" << std::endl;
