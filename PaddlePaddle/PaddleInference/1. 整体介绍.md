...
# gpu(cudnn) 
cmake ..  -DCMAKE_BUILD_TYPE=Release -DON_INFER=ON  -DPY_VERSION=3.7 -DWITH_GPU=ON  -DCUDA_ARCH_NAME=Auto  -DWITH_TENSORRT=OFF \-DCUDA_TOOLKIT_ROOT_DIR=/usr/local/cuda/
